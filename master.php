...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="profile.php"  class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Apartements</a> 
    <a href="Settings.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fas fa-cog w3-margin-right"></i>Update Info</a> 
    <a href="changeemail.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fas fa-cog w3-margin-right"></i>Change Email</a> 
    ...
    <a href="changeprofimg.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fas fa-cog w3-margin-right"></i>Change Profile Picture</a> 
  ...
  <a href="  logout.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fas fa-sign-out-alt w3-margin-right"></i>Log Out</a>
      <a href="deactive.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fas fa-trash w3-margin-right"></i>Deactive</a>
  </div>
