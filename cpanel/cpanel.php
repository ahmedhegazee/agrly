...
<td>Verify</td>
  ...
  while($myrow = mysqli_fetch_array($result))
  {
   ...
   // echo"<td><a  href='http://localhost:8080/agrly/cpanel/edituser.php?uid=".$myrow["userid"]."'>Edit User</a></td>";
    echo"<td><input type=button value='Delete' onclick='deleteu(".$userid.");'/></td>";
    echo"<td><input type=button value='Deactive' onclick='deactive(".$userid.");'/></td>";
    $uemail=$myrow["useremail"];
    $verified=$myrow["verified"];
    echo"<td><input type=button value='Send Code' onclick="."\"sendverification('$uemail','$verified');\"/></td>";
